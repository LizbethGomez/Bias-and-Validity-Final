...
calculate_odds_and_weighted_risk_difference <- function(trial_population, target_population, trial_Z1_percent, target_Z1_percent, effect_Z1, effect_Z0) {
...
# Example usage
result <- calculate_odds_and_weighted_risk_difference(2000, 2000, 50, 80, -0.2, 0.0)
print(result)
